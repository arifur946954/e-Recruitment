...
//this is left sidebar menu
export const verticalMenuItems = [ 
    new Menu ("MENU000001", 'Home', '/home', null, 'home', null, false, "0"), // id, title, routerlink, href, icon, target, hasSubMenu, parentId
    new Menu ("MENU000002", 'LC Dashboard', '/dashboard', null, 'grid_on', null, false, "0"), 
    new Menu ("MENU00000X", 'File Input', '/file', null, 'link', null, false, "0"), 
    new Menu ("MENU000011", 'LC Expenses Verify', '/lCExpensesVerify', null, 'add_task', null, false, "0"), 
    new Menu ("MENU000012", 'LC Expenses Approve', '/lCExpensesApprove', null, 'done_all', null, false, "0"), 
    new Menu ("MENU000013", 'LC Duty', '/lCDuty', null, 'upgrade', null, false, "0"), 

    new Menu ("MENU000014", 'Sales Dashboard', null, null, 'auto_graph', null, true, "0"), 
    new Menu ("MENU000015", 'Sales', '/salesDashboard/sales', null, 'bar_chart', null, false, "MENU000014"),
    new Menu ("MENU000016", 'Delivery', '/salesDashboard/delivery', null, 'shopping_cart', null, false, "MENU000014"),
    new Menu ("MENU000017", 'Party Ledger', '/salesDashboard/partyLedger', null, 'attach_money', null, false, "MENU000014"),
    new Menu ("MENU000018", 'Truck Status', '/salesDashboard/truckStatus', null, 'directions_bus', null, false, "MENU000014"),

    new Menu ("MENU000005", 'Security', null, null, 'settings', null, true, "0"), 
    new Menu ("MENU000006", 'Role', '/security/role', null, 'verified_user', null, false, "MENU000005"), 
    new Menu ("MENU000007", 'Menu', '/security/menu', null, 'menu', null, false, "MENU000005"), 
    new Menu ("MENU000008", 'Role Menu Assign', '/security/roleMenuAssign', null, 'post_add', null, false, "MENU000005"), 
    new Menu ("MENU000009", 'User Role Assign', '/security/userRoleAssign', null, 'group_add', null, false, "MENU000005"), 
    new Menu ("MENU000010", 'DUTY Admin', '/security/dutyAdmin', null, 'attach_money', null, false, "MENU000005"),
    new Menu ("MENU000019", 'Sales Admin', null , 'http://dashboard.citygroupbd.com/dashboard/admin.html', 'trending_up', '_blank', false, "MENU000005"),
    ...
    new Menu ("144", 'Level 5', null, 'http://themeseason.com', 'link', null, false, "143"), // id, title, routerlink, href, icon, target, hasSubMenu, parentId
    new Menu ("200", 'External Link', null, 'http://themeseason.com', 'open_in_new', '_blank', false, "0") // id, title, routerlink, href, icon, target, hasSubMenu, parentId 
]
