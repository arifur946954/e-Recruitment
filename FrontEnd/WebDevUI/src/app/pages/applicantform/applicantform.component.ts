...
import { FormGroup, FormBuilder, Validators, FormControl, AbstractControl, ValidatorFn, FormArray} from '@angular/forms';
import { emailValidator } from '../../theme/utils/app-validators';
import { AppSettings } from '../../app.settings';
import { Settings } from '../../app.settings.model';
import {ApiService} from '../../api/api.service';
import { ToastrService } from 'ngx-toastr';
import { User } from 'src/app/pages/applicantform/applicantform_model';
...
import { ReportViewer } from 'src/app/project_component/reportviewer/reportviewer';
...
@Component({
  ...
  styleUrls : ["./applicantform.component.scss"]
})
